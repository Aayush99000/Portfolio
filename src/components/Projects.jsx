    ...
    <section id="projects" ref={ref}>
      <div className="container">
            ...
            >
              ...
              <div style={{ direction: 'ltr', padding: '36px 36px' }}>
                <div style={{
                  ...
                  color: p.color, letterSpacing: '0.1em', marginBottom: 10,
                ...
                <div style={{ display: 'flex', gap: 16 }}>
                  {p.github && (
                    <a href={p.github} target="_blank" rel="noopener noreferrer"
                      style={{ color: 'var(--muted)', display: 'flex', alignItems: 'center', gap: 6, textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.2s' }}
        ...
        <motion.h3
          ...
          style={{ textAlign: 'center', color: 'var(--muted)', fontSize: '0.9rem', marginBottom: 32, fontFamily: 'JetBrains Mono' }}
        >
          ...
          {rest.map((p, i) => (
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <h3 style={{ fontSize: '0.98rem', fontWeight: 700, color: '#e2e8f0', flex: 1 }}>{p.title}</h3>
                <div style={{ display: 'flex', gap: 12, color: 'var(--muted)', marginLeft: 12 }}>
                  {p.github && (
                    <a href={p.github} target="_blank" rel="noopener noreferrer"
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginTop: 'auto', paddingTop: 8 }}>
                {p.tags.map(t => (
                  <span key={t} style={{
                    fontFamily: 'JetBrains Mono', fontSize: '0.7rem', color: `${p.color}90`,
                    background: `${p.color}10`, padding: '3px 10px', borderRadius: 20,
                    border: `1px solid ${p.color}25`,
                  }}>{t}</span>
                ))}
              </div>
