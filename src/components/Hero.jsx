  ...
  return (
    <section id="hero" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', position: 'relative' }}>
      <div className="container">
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.p variants={item} style={{
            ...
            MS Data Science @ Northeastern University. I specialise in computer vision, NLP,
            and building production-ready AI systems — from satellite imagery segmentation
          ...
          <motion.div variants={item} style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
            <a
              ...
              onMouseEnter={e => { e.target.style.transform = 'translateY(-2px)'; e.target.style.boxShadow = '0 8px 40px rgba(0,212,255,0.4)' }}
              onMouseLeave={e => { e.target.style.transform = ''; e.target.style.boxShadow = '0 0 30px rgba(0,212,255,0.25)' }}
            >
              View My Work
            </a>
            <a
              ...
              onMouseLeave={e => { e.target.style.background = 'transparent'; e.target.style.borderColor = 'rgba(0,212,255,0.4)' }}
            >
              Get In Touch
            </a>
          </motion.div>
          ...
          <motion.div variants={item} style={{
            ...
            {[
              { href: 'https://github.com/Aayush99000', label: 'GitHub', icon: (
              ...
              { href: 'https://linkedin.com/in/aayush-katoch-a47413175', label: 'LinkedIn', icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              )},
              { href: 'mailto:katoch.aa@northeastern.edu', label: 'Email', icon: (
              ...
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                ...
                onMouseEnter={e => { e.currentTarget.style.color = '#00d4ff'; e.currentTarget.style.transform = 'translateY(-3px)' }}
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'JetBrains Mono', fontSize: '0.65rem', color: 'var(--muted)', letterSpacing: '0.15em' }}>SCROLL</span>
        <svg width="16" height="24" viewBox="0 0 16 24" fill="none">
          <rect x="1" y="1" width="14" height="22" rx="7" stroke="rgba(0,212,255,0.4)" strokeWidth="1.5"/>
